...
{
    /// <inheritdoc />
    public partial class FixBillModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ConsultationFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MedicineCharges = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "DoctorId", "Address", "AvailableFrom", "AvailableTo", "ConsultationFee", "CreatedAt", "Email", "ExperienceYears", "IsAvailable", "Name", "Phone", "Qualification", "Specialization" },
                values: new object[,]
                {
                    { 1, "Cardiology Department, City Hospital", new TimeOnly(9, 0, 0), new TimeOnly(17, 0, 0), 800m, new DateTime(2025, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "dr.rajesh@hospital.com", 15, true, "Dr. Rajesh Kumar", "9876543210", "MD, DM Cardiology", "Cardiology" },
                    { 2, "Pediatrics Department, City Hospital", new TimeOnly(10, 0, 0), new TimeOnly(18, 0, 0), 600m, new DateTime(2025, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "dr.priya@hospital.com", 10, true, "Dr. Priya Sharma", "9876543211", "MD Pediatrics", "Pediatrics" }
                });
